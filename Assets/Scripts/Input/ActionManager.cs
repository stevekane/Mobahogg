...
/*
This class acts as an intermediary between raw InputActions and gameplay code.

There are several purposes to this class:

1. Store buffer of inputs to create more natural-feeling gameplay responsiveness
2. Create more idiomatically-clear event names "button just up"
3. Store button state durations like time-held
4. Aggregate inputs from arbitrarily-many raw devices into a single "input state" for a slot
5.
*/
